...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 OptiTex ofrece un paquete completo para suplir este tipo de necesidades, estos softwares son:
    ...
    .row.fondo-gris-1.py-5.mb-5
      ...
      .col-lg-10.py-3
        figure.mb-4
          p.BorTit <b>Figura 15.</b> Interfaz general de OptiTex PDS
      ...
      .col-lg-10
        ol.lista-ol--cuadro.lista-ol--separador
          ...
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span c
            | Contiene herramientas que propician la construcción de patrones desde cero, transformación, marcaciones, mediciones, escalado y posee características que permite el complemento con los demás paquetes de software.
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span d
            | Importación y exportación de diferentes extensiones de patrones realizados en otros softwares de trazo de aplicaciones CAD/CAM.
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span e
          ...
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span f
            | Se pueden imprimir moldes o patrones directamente a una impresa a la escala que se desee. 
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span g
          ...
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span h
            | Cantidad   de   características: ojales, pinzas, pliegues, costuras, manejo de curvas complicadas, esquinas, cortes, técnicas avanzadas de medición, botones y piquetes.
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span i
          ...
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span k
            | El programa que complementa a OptiTex PDS es Marker, en donde una vez se realice el trazado de los moldes en un espacio que está determinado a partir de anchos de tela y largos de tendido para producción, es posible pasar a hacer el plano que guie el tendido y corte de la producción a confeccionar.
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span l
          ...
          li
            .lista-ol--cuadro__vineta.color-acento-botones-1
              span m
            | Reporte de información de piezas a Excel para integración con cualquier generador de reportes a su gusto.
    ...
    AcordionA.mb-4(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
      .row(titulo="A. Activación de herramientas")
        ...
        .col-md-9
          ...
          figure.mb-5
            p.BorTit <b>Figura 18.</b> Caja de herramientas
          ...
          figure.mb-5
            p.BorTit <b>Figura 19.</b> Activación de herramientas
      ...
      .row(titulo="B. Configurar área de trabajo")
        ...
        .col-md-9
          ...
          figure.mb-5
            p.BorTit <b>Figura 20.</b> Preferencias
      ...
      .row(titulo="D. Menú principal")
        ...
        .col-md-9
          ...
          figure.mb-5
            p.BorTit <b>Figura 24.</b> Menú principal
      ...
      .row(titulo="E. Menú de herramientas gráficas")
        ...
        .col-md-9          
          ...
          figure.mb-4
            p.BorTit <b>Figura 25.</b> Herramientas generales
      ...
      .row(titulo="F. Ventana de piezas")
        ...
        .col-md-9
          ...
          figure.mb-5
            p.BorTit <b>Figura 26.</b> Ventana piezas
    ...
    .row.fondo-a.py-5.mb-5
      ...
      .col-lg-10.py-3
        figure.mb-4
          p.BorTit <b>Figura 27.</b> Creación de rectángulo
    ...
    .row.fondo-d.mb-5
      .col-lg-5.p-5
        figure.mb-4
          p.BorTit <b>Figura 28.</b> Escalado
    ...
    .row.mb-5
      .col-lg-6.d-flex
        div.fondo-a.p-5
          figure.mb-4
            p.BorTit <b>Figura 29.</b> Apertura de tabla de tallas
            img(src='@/assets/curso/tema2/img16.png')
            figcaption Fuente: SENA 2021
      .col-lg-6.d-flex
        div.fondo-b.p-5
          figure.mb-4
            p.BorTit <b>Figura 30.</b> Tallas
